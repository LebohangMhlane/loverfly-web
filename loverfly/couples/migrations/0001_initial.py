    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('couple_data', models.CharField(blank=True, max_length=800, null=True)),
                ('started_dating', models.DateField(default=django.utils.timezone.now)),
                ('anniversaries', models.PositiveBigIntegerField(default=0)),
                ('admirers', models.PositiveBigIntegerField(blank=True, default=0)),
                ...
                ('relationship_status', models.CharField(default='Dating', max_length=100)),
                ...
                ('partner_one', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='partner_one', to='accounts.userprofile')),
                ('partner_two', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='partner_two', to='accounts.userprofile')),
            ],
        ),
    ]
