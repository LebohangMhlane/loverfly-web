    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_linkage_code', models.CharField(blank=True, max_length=5, null=True, unique=True)),
                ...
                ('my_partner', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='partner', to='accounts.userprofile')),
